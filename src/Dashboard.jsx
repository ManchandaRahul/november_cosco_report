...
const Dashboard = () =>{
  ...
  // === SUPPORT HOURS DATA (UPDATED TO INCLUDE NOVEMBER 2025) ===
  const supportHoursData = [
    ...
    { month: 'Aug', hours: 59.0, change: -4, source: 'Excel Summary', incidents: 15, resolved: 14 },
    ...
    { month: 'Nov', hours: 86.0, change: -20, source: 'Excel Summary', incidents: 10, resolved: 10 }
  ];

  // Recalculate Nov % change based on actual data (already set above)
  const octHours = supportHoursData[5].hours;
  const novHours = supportHoursData[6].hours;
  supportHoursData[6].change = Math.round(((novHours - octHours) / octHours) * 100);

  const totalHours = supportHoursData.reduce((sum, m) => sum + m.hours, 0).toFixed(1);
  const mayHours = supportHoursData[0].hours;
  const mayToNovPct = Math.round(((novHours - mayHours) / mayHours) * 100);

  // === DEPLOYMENT DATA (NO CHANGE - NO NEW DEPLOYMENTS IN NOVEMBER) ===
  ...
  // === ENHANCEMENT TREND (UPDATED WITH NOVEMBER) ===
  ...
  // === ISSUE TIMELINE (UPDATED TO INCLUDE NOVEMBER) ===
  const issueTimeline = [
    {
    ...
    },
    {
      ...
      may: 'low', jun: 'medium', jul: 'high', aug: 'high', sep: 'medium', oct: 'none', nov: 'none',
      description: 'No duplication incidents in November monitored runs',
      impact: 'Medium',
      trend: 'Resolved',
      trendShort: 'Resolved'
    },
    {
      ...
      may: 'medium', jun: 'medium', jul: 'medium', aug: 'medium', sep: 'medium', oct: 'low', nov: 'low',
    ...
    },
    {
      ...
      may: 'none', jun: 'none', jul: 'high', aug: 'medium', sep: 'low', oct: 'high', nov: 'medium',
      description: 'Some selector fixes deployed, minor incidents',
      impact: 'High',
      trend: 'Recurring',
      trendShort: 'Recurring'
    },
    {
      ...
      may: 'none', jun: 'medium', jul: 'medium', aug: 'low', sep: 'low', oct: 'low', nov: 'low',
      description: 'Stable with ongoing monitoring',
      impact: 'Low',
      trend: 'Stable',
      trendShort: 'Stable'
    }
  ...
  >
    <b><u>Back</u></b> 
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold mb-1">COSCO AMC Monitoring</h1>
              <p className="text-blue-100 text-sm">Review Period: May – November 2025</p>
            </div>
            <div className="text-right">
              <div className="text-sm text-blue-100 mb-1">Report Date</div>
              <div className="text-lg font-semibold">December 18, 2025</div>
            </div>
          </div>
        </div>
      </div>
...
{/* ==== END BANNER ==== */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                <Info className="w-6 h-6 text-blue-600" /> Key Findings (May - November 2025)
              </h3>
              <div className="grid grid-cols-2 gap-4">
                      ...
                      <p className="text-sm text-gray-700">
                        Only <strong>18</strong> issues/bugs from May - Nov 2025                   
                                            ...
                                            <p className="text-sm text-green-700">
                                              <br></br>      
                         {/* *<strong>150 hours of regular maintenance from Nov'24 to Apr'25  </strong> */}
                ...
                <div className="bg-white rounded-lg p-4 border border-blue-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1">No Duplicates in Oct, Nov</h4>
                      <p className="text-sm text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-700">
                        <strong>527.5 hours</strong> of support from May - Nov 2025 vis-a-vis <strong>360 hours</strong> of Annual Committed Support Hours
                      <br></br>
                      <br></br>
            ...
            {/* <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Support Hours Trend (May - Nov 2025)</h3>
              ...
              <div className="overflow-x-auto border border-gray-200 rounded-lg">
                <table className="w-full text-xs">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    {/* November */}
                    <tr className="hover:bg-blue-50/30">
                      <td className="px-3 py-2 font-medium text-gray-900">Nov-25</td>
                      <td className="px-3 py-2 text-center text-green-600">20.0</td>
                      <td className="px-3 py-2 text-center text-orange-600">43.0</td>
                      <td className="px-3 py-2 text-center">0</td>
                      <td className="px-3 py-2 text-center">23.0</td>
                      <td className="px-3 py-2 text-right font-semibold text-gray-900">86.0</td>
                    </tr>
                    {/* Grand Total */}
                    <tr className="bg-blue-100 font-bold">
                      <td className="px-3 py-2 text-blue-900">Grand Total</td>
                      <td className="px-3 py-2 text-center text-green-700">147.5</td>
                      <td className="px-3 py-2 text-center text-orange-700">80.5</td>
                      <td className="px-3 py-2 text-center">81.5</td>
                      <td className="px-3 py-2 text-center text-gray-700">218</td>
                      <td className="px-3 py-2 text-right text-blue-900">527.5</td>
                    </tr>
                  </tbody>
                </table>
              </div>

              {/* Enhancement Hours Trend Chart */}
              {/* <div className="mt-8">
        ...
        {/* === TRENDS & ANALYTICS === */}
{/* === TRENDS & ANALYTICS (Now contains ALL graphs) === */}
        {activeView === 'trends' && (
          <div className="space-y-8">
            {/* 1. Support Hours Trend */}
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Support Hours Trend (May - Nov 2025)</h3>
            ...
            {/* 2. CR/Enhancement Hours Trend */}
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">CR/Enhancement Hours Trend</h3>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={enhancementTrend}>
                  <CartesianGrid strokeDasharray="3 3" />
            ...
            {/* <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={380}>
                <BarChart data={supportHoursData.slice(1).map((cur, i) => {
                  ...
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="transition" angle={-45} textAnchor="end" height={70} />
                  <YAxis domain={[-100, 150]} tick={{ fontSize: 12 }} />
                  <Tooltip formatter={(v, name) => name === 'hours' ? `${v} hrs` : `${v}%`} />
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-5">
                <h4 className="font-semibold text-green-900 mb-2">Continued Recovery</h4>
                <p className="text-sm text-green-800"><strong>Oct to Nov: -22 hrs (-20%)</strong></p>
              </div>
            </div>
          </div>
        )}
        ...
        <table className="w-full text-xs">
          <thead className="bg-gray-50 border-b">
            <tr>
              ...
              {['may','jun','jul','aug','sep','oct','nov'].map(m => (
          ...
          <tbody>
            {issueTimeline.map((issue, i) => (
              <tr key={i} className="border-b hover:bg-gray-50">
                ...
                {/* Month Frequency - Colored rounded boxes (unchanged) */}
                {['may','jun','jul','aug','sep','oct','nov'].map(month => (
                  <td key={month} className="text-center py-3 px-2">
                    <div className="h-10 w-20 mx-auto rounded flex items-center justify-center font-bold text-xs"
                         style={{ backgroundColor: getHeatmapColor(issue[month]) }}>
                      {issue[month] !== 'none' && issue[month].toUpperCase()}
                    </div>
                  </td>
                ))}
                
                {/* Trend - Colored text, same font size as months */}
                <td className="text-center py-3 px-4">
                  <span className={`font-bold text-xs ${
                    issue.trendShort === 'Resolved' ? 'text-blue-700' :
                    issue.trendShort === 'Improving' ? 'text-green-700' :
                    issue.trendShort === 'Stable' ? 'text-yellow-800' :
                    'text-orange-700'  // Recurring
                  }`}>
                    {issue.trendShort.toUpperCase()}
                  </span>
                </td>
                
                {/* Impact - Colored text, same font size as months */}
                <td className="text-center py-3 px-4">
                  <span className={`font-bold text-xs ${
                    issue.impact === 'High' ? 'text-red-700' :
                    issue.impact === 'Medium' ? 'text-amber-700' :
                    'text-green-700'  // Low
                  }`}>
  ...
  <div className="space-y-6">
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="space-y-4">
        {rootCauses.map((rc, i) => (
          <div key={i} className="border-l-4 border-blue-600 bg-gray-50 p-4 rounded-r-lg">
            <div className="flex justify-between items-center mb-2">
              ...
              {/* Fixed-size severity pill - same width for all */}
              <div className="h-10 w-28 rounded-full flex items-center justify-center border">
                <span className={`text-xs font-bold ${getSeverityColor(rc.severity).replace('border-', '').replace('bg-', 'text-').replace('border-', '')}`}>
        ...
        {activeView === 'actions' && (
          <div className="space-y-6">
            {/* ONLY PHASE 2 + EXPECTED OUTCOMES */}
            <div className="bg-white rounded-lg shadow-lg p-6 border-t-4 border-indigo-600">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                  ...
                  <div>
                    <p className="font-medium text-indigo-900">Bank statement upload automation.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                  ...
                  <div>
                    <p className="font-medium text-indigo-900">Import document convert from draft to Final.</p>
                  </div>
                </div>
                 ...
                 <div className="flex items-start gap-3 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                  <CheckCircle className="w-5 h-5 text-indigo-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-indigo-900">AI features - extract UTR from payment receipt, NOC auto approval</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-blue-200">
                  <AlertCircle className="w-5 h-5 text-black-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-gray-900">Reduce the bot processing time to 2hrs from the current processing time of 4hrs(post submitting the form)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-purple-200">
                  <AlertCircle className="w-5 h-5 text-black-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-gray-900">⁠Reduce processing time to 1.5-2 mins per record from current 2.5 mins</p>
                  </div>
                </div>
